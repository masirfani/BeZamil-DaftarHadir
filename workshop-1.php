...
<body style="background: url('assets/img/background.jpg');background-size: cover;background-repeat: no-repeat;background-position: center;">
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow">
                    <div class="card-body">
                        ...
                        <h3 class="text-center">Daftar Kehadiran<br>Workshop 1: Hematology</h3>
                        <hr />
                        <form action="aksi.php" method="POST">
                            <input type="hidden" name="tipe" value="Workshop 1: Hematology">
    ...
    <script>
        $(document).ready(function() {
            ...
            var sheetName = "WS 1 HEMA"; // Ganti dengan nama sheet Anda
